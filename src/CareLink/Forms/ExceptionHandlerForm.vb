...
Public Class ExceptionHandlerForm
    ...
    Private Sub ExceptionHandlerForm_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If String.IsNullOrWhiteSpace(Me.ReportFileNameWithPath) Then
            ...
            Me.InstructionsRichTextBox.Text = $"By clicking OK, the Stack Trace, Exception and the CareLink{TmChar} data that caused the error will be package as a text file called{s_environmentNewLine}"
        ...
        Else
            ...
            If CurrentDateCulture Is Nothing Then
                ...
                Exit Sub
            End If
            Me.InstructionsRichTextBox.Text = $"Clicking OK will rerun the data file that caused the error{s_environmentNewLine}"
