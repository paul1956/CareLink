...
Friend Module UserMessageHandler
    ...
    Private ReadOnly s_unitsStrings As New Dictionary(Of String, String) From {
                            {"MGDL", "mg/dl"},
                            {"MMOLL", "mmol/L"},
                            {"MMOL_L", "mmol/L"}
                        }

    Friend ReadOnly s_messages As New Dictionary(Of String, String) From {
    ...
    Friend Function GetLocalizedUnits(unitName As String) As String
        Return s_unitsStrings(unitName)
    End Function
    ...
    Friend Function TranslateMessageId(dic As Dictionary(Of String, String), entryValue As String, TimeFormat As String) As String
        ...
        If s_messages.TryGetValue(entryValue, formattedMessage) Then
        Else
