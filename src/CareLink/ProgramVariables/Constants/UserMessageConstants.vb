...
Friend Module UserMessageConstants
    ...
    Friend ReadOnly s_notificationMessages As New Dictionary(Of String, String) From {
            ...
            {"BC_SID_SEVEN_DAYS_SINCE_LAST_SET_CHANGE", "Set change reminder at(triggeredDateTime), Seven days since the last infusion set change. Time to change the infusion set"},
