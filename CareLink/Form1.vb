...
Public Class Form1
    ...
    Private Shared Function GetInnerTable(tableLevel1Blue As TableLayoutPanel, innerJson As Dictionary(Of String, String), itemIndex As Integer) As TableLayoutPanel
