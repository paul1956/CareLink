...
Friend Module DeviceSettingsExtensions
    ...
    Friend Function GetSingleLineValue(Of T)(line As String, key As String, Optional endsWith As String = "") As T
        ...
        If line.StartsWith(value:=key, ComparisonType) Then
            ...
            Dim value As String = line.TruncateAtKeyword(key:=endsWith).Trim()
        ...
        Dim message As String =
            $"Unsupported type '{typeOfT.FullName}' in GetSingleLineValue."
    ...
    Friend Function GetSingleLineValue(Of T)(sTable As StringTable, key As String, Optional endsWith As String = "") As T
        ...
        For Each r As StringTable.Row In sTable.Rows
            ...
            If v.StartsWith(value:=key) Then
                If Not String.IsNullOrEmpty(value:=endsWith) Then
                    v = v.RemoveSuffix(suffix:=endsWith)
                End If
    ...
    <Extension>
    Public Function EqualCarbRatios(
        deviceCarbRatios As List(Of DeviceCarbRatioRecord),
        carbRatios As List(Of CarbRatioRecord)) As Boolean
