...
Public Class LoginForm1
    ...
    Private Sub OK_Button_Click(sender As Object, e As System.EventArgs) Handles Ok_Button.Click
        ...
        Select Case MsgBox($"Login Unsuccessful, {networkDownMessage}. try again? If 'Abort' program will exit!", MsgBoxStyle.AbortRetryIgnore Or MsgBoxStyle.DefaultButton2, Title:="Login Failed")
