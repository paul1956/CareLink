...
Friend Module UserMessageConstants
    ...
    Public ReadOnly s_faultIdMessages As New Dictionary(Of String, String) From {
        {"817", "817"}}
    ...
    Friend ReadOnly s_notificationMessages As New Dictionary(Of String, String) From {
        {"19", "Loading Incomplete During Infusion Set Change(dateTime)"},
        ...
        {"105", "Low Reservoir(triggeredDateTime). (0) units remaining. Change reservoir.:unitsRemaining"},
        {"802", "Alert on low (0) (units)(triggeredDateTime). Low sensor glucose. Check BG:sg"},
        ...
        {"BC_SID_CANNOT_RESUME_BOLUS_FILL_CANNULA", "Bolus stopped(triggeredDateTime). Cannot resume bolus for cannula fill, (deliveredAmount) of (programmedAmount) U delivered. {vbCrLf}(notDeliveredAmount) U not delivered. If needed, enter values again"},
        ...
        {"BC_SID_WAIT_AT_LEAST_15_MINUTES", "Calibration Not accepted(triggeredDateTime) .Wait at least 15 minutes. Wash hands, test BG again and calibrate"},
