...
Friend Module AutoBasalDeliveryRecordHelpers
    ...
    Private ReadOnly s_columnsToHide As New List(Of String) From {
            ...
            NameOf(AutoBasalDelivery.relativeOffset),
            NameOf(AutoBasalDelivery.version)
        }

    Private s_alignmentTable As New Dictionary(Of String, DataGridViewCellStyle)

    Friend Function GetCellStyle(columnName As String) As DataGridViewCellStyle
        Return ClassPropertiesToColumnAlignment(Of AutoBasalDelivery)(s_alignmentTable, columnName)
    End Function
