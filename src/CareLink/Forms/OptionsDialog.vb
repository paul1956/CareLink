...
Public Class OptionsDialog
    ...
    Private Sub ItemNameComboBox_DrawItem(sender As Object, e As DrawItemEventArgs) Handles ItemNameComboBox.DrawItem
        If e.Index >= 0 Then
            ...
            End Using
            Using b As Brush = New SolidBrush(keyValuePair.Value.ToColor)
    ...
    Private Sub ItemNameComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ItemNameComboBox.SelectedIndexChanged
        If AllKnownColors.Count = 0 Then Exit Sub
        Me.KnownColorsComboBox.SelectedIndex = AllKnownColors.IndexOfValue(CKvp(Me.ItemNameComboBox.SelectedItem).Value)
    ...
    Private Sub KnownColorsComboBox_SelectedIndexChanged(sender As Object, e As EventArgs) Handles KnownColorsComboBox.SelectedIndexChanged
        ...
        Dim knownColor As KnownColor = AllKnownColors(CKvp(Me.KnownColorsComboBox.SelectedItem).Key)
    ...
    Private Sub OptionsDialog_Load(sender As Object, e As EventArgs) Handles Me.Load
        ...
        Me.KnownColorsComboBox.DataSource = New BindingSource(AllKnownColors, Nothing)
    ...
    Private Sub UpdateForeground_Button_Click(sender As Object, e As EventArgs) Handles UpdateForeground_Button.Click
        Dim item As KeyValuePair(Of String, KnownColor) = CKvp(Me.KnownColorsComboBox.SelectedItem)
        GraphColorDictionary(CKvp(Me.ItemNameComboBox.SelectedItem).Key) = item.Value
        Me.ItemNameComboBox.DataSource = New BindingSource(GraphColorDictionary, Nothing)
